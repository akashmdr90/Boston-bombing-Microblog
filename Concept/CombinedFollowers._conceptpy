    ...
    for th in thresh:
        ...
        for t in sorted(rumor_type):
            ...
            for val in threshold:
                ...
                jac_labeled_tweets, rumor_word_count = ut.labelDataJaccardConcept(tweets, rumor_word_count, val, rumor_list, conceptDict, th, followerDict)
                g_tweets = []
                na_tweets = []
                ...
                labeled_tweets, rumor_edge_count = ut.labelGraphConcept(g_tweets, rumor_edge_count, val, rumor_list.__len__(), conceptDict, th, followerDict)
                labeled_tweets[11] += na_tweets
            ...
            ut.calculations(sorted_scores,rumor_category,t, th, "Combined")
            ...
            save_path = os.getcwd()+"/Files/Combined/"+th+"/"+t
