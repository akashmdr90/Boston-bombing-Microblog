    ...
    for t in sorted(rumor_type):
        ...
        for rumor in rumor_list:
            ...
            if k == 2:
                ...
                edge_dict, wordnetDictGraph = ut.construct_graph(rumor, wordnetDictGraph)
        ...
        for val in threshold:
            ...
            jac_labeled_tweets, rumor_word_count, wordnetDict = ut.label_data(tweets, rumor_word_count, val, rumor_list, wordnetDict)
            g_tweets = []
            na_tweets = []
            ...
            labeled_tweets, rumor_edge_count, wordnetDictGraph = ut.label_data_graph(g_tweets, rumor_edge_count, val, rumor_list.__len__(), wordnetDictGraph)
