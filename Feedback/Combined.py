    ...
    for th in thresh:
        ...
        for t in sorted(rumor_type):
            ...
            for val in threshold:
                ...
                jac_labeled_tweets, rumor_word_count = ut.label_data_jaccard(tweets, rumor_word_count, val, rumor_list, th, followerDict)
                g_tweets = []
                na_tweets = []
                ...
                labeled_tweets, rumor_edge_count = ut.label_data_graph(g_tweets, rumor_edge_count, val, rumor_list.__len__(), th, followerDict)
